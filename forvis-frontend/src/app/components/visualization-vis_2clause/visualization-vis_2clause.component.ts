...
@Component({
  selector: 'app-visualization-vis_2clause',
  templateUrl: './visualization-vis_2clause.component.html',
  styleUrls: ['./visualization-vis_2clause.component.css'],
  standalone: true,
...
export class VisualizationVis2ClauseComponent extends DownloadableComponent implements OnInit {
  ...
  private readonly timeCycleCounts = 60;
